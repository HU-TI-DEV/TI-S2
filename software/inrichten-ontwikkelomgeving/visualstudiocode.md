...
Doorloop alle stappen op de volgende pagina: https://code.visualstudio.com/docs/cpp/config-mingw
...
### Arduino IDE
Om programma's te maken voor de Arduino Uno of de Raspberry Pi Pico maken we gebruik van de Arduino IDE.De Arduino IDE (Integrated Development Environment) is gratis, open-source software voor Windows, Mac en Linux waarmee je code (sketches) schrijft, compileert en uploadt naar een Arduino-bord. 
