...
C4 | di | Schuifregister & SPI | Werken aan project | Schakelaars maken t.b.v. deurdetectie, Datasheet lezen (**MV**)
...
Onderwijsweek | Dag | Thema | Project | Kennissessie
--- | --- | --- | --- | ---
C5 | ma |  | Werken aan project | Electrisch Schema, Weerstanden en pullup/pulldown (**MV**)
C5 | di |  | Werken aan project | Spanningsbronnen (**MV**)
...
Onderwijsweek | Dag | Thema | Project | Kennissessie
--- | --- | --- | --- | ---
D1 | ma | | Werken aan project | Beschrijvingen, UC Diagram (**MV**)
