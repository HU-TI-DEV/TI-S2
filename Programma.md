...
| C1            | wo  | Project Kick-off. Inrichten van een [ontwikkelomgeving](./software/inrichten-ontwikkelomgeving/readme.md) & werken met [Git](./software/git/readme.md).                                                                                                                                                                                                                                                                                  | Werken aan project                                                                                                  | [SI eenheden](./programma/programma-si-eenheden.md). (**MV**) [Rekenkundige expressies](./software/c++/expressies/README.md). (**GP**)                                                                                                                                                                                                                                     |
...
| C4            | di  | Schuifregister & SPI                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Schakelaars maken t.b.v. deurdetectie, Werken aan project | UC Diagram, UC Beschrijvingen **(MV)** |
