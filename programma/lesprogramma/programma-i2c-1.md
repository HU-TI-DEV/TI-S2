...
## Voorbereiding
- Neem je electronica spullen mee:
  - Arduino UNO (met toebehoren)
  - breadboard
  - weerstanden, LEDs, buttons
  - draadjes
  - **logic analyzer** (als je deze al hebt)
  - etc.
- Bestudeer [de I2C pagina in hardware-interfacing/communicatie](../../hardware-interfacing/communicatie/I2C/README.md).
...
## De volgende les
- Vermoedelijk lukt het afronden niet helemaal tijdens de eerste les.
- Tijdens de [volgende les](./programma-i2c-2-3.md) ronden we het af, en maken we een begin met het vervolgpracticum: het aansturen van een pcf8574 via I2C.
